...
var SwipeView = (function(){
	var hasTouch = 'ontouchstart' in window,
		...
		SwipeView = function (el, options) {
			...
			div.style.cssText = 'z-index:-1;position:absolute;top:0;height:100%;width:100%;-webkit-transition-duration:0;-webkit-transform:translate3d(0,0,0);-webkit-transition-timining-function:ease-out';
			this.wrapper.appendChild(div);						
			this.slider2 = div;
			
			div = document.createElement('div');
			div.id = 'swipeview-slider';
			div.style.cssText = 'text-align:left;position:absolute;top:0;height:100%;width:100%;-webkit-transition-duration:0;-webkit-transform:translate3d(0,0,0);-webkit-transition-timining-function:ease-out';
			this.wrapper.appendChild(div);			
			this.slider = div;
...
/*			if (newX > 0 || newX < this.maxX) {
		...
		__checkPositionY: function () {
			...
			// Add active class to current page
			className = this.masterPages2[this.currentMasterPage].className;
